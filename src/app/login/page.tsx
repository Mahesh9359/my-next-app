            ...
            <div className="mt-4">
              ...
              <div className="flex justify-center gap-4">
                <button
                  ...
                  className="flex items-center gap-3 px-5 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50"
                >
                  <Image
                    src={googleIcon}
                    alt="Google Logo"
                ...
                <button
                  ...
                  className="flex items-center gap-3 px-5 py-2 border-[#44444] rounded-md shadow-sm text-sm font-medium text-white bg-[#444444] hover:bg-[#4e4e4e]"
                >
                  <Image
                    src={githubIcon}
                    alt="GitHub Logo"
